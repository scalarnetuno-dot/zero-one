...
:::art caption="Para a Vera eram onze da noite; para o servidor, duas da manhã."
src="para-a-vera-eram-onze-da-noite-para-o-servidor-duas-da-manha.png"
Charge editorial minimalista em fundo branco, composição dividida por uma
linha tracejada vertical. À esquerda, uma bibliotecária mais velha tranca a
porta de uma pequena biblioteca de bairro sob um poste aceso, e um relógio
de parede na fachada marca 23h. À direita, muito longe, um servidor de rack
solitário num galpão frio, com uma placa discreta escrita "VIRGINIA" e um
relógio digital marcando 02:03. Entre os dois, um envelope de aviso de
multa já voando em direção a uma caixa de correio. Poucos elementos, humor
seco, estética de revista de tecnologia.
:::
