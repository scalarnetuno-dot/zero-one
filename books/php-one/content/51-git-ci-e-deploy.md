...
torna o `singleton` do capítulo @cap:service-container ainda mais
perigoso; a documentação do Laravel tem uma seção inteira sobre o que muda.
...
artigos sobre banco compartilhado × banco por cliente.
...
dezenas de equipes; para uma biblioteca com três conceitos e um computador,
a resposta é a do caderno da Tainá.

:::story A horta
No dia primeiro de abril, a Vera chegou às oito e quarenta, como em todos
os dias dos últimos trinta e um anos. Ligou o computador do balcão, abriu o
painel novo e conferiu o resumo do dia: quatro devoluções na caixa, nenhum
atrasado novo, duas reservas esperando.

Depois abriu a gaveta de baixo e tirou o bloco de fichas de empréstimo de
papel, as amarelas, com o carimbo da associação. Imprimiu uma pelo painel,
por hábito — o sistema novo também sabia imprimir —, e ficou olhando as
duas lado a lado: a de papel, em branco, e a impressa, com o nome da Dona
Marlene, o título, o tombo e a data de devolução.

Dobrou a impressa em quatro e guardou no bolso do avental.

Tainá chegou às nove, com o caderno. Estava na última página.

— Acabou? — perguntou Vera.
...
— "Perguntar pra quem faz o trabalho antes de escrever o código."

Vera pensou um pouco.

— Isso devia estar na primeira.

A porta abriu. Seu Juvenal entrou com uma sacola de mudas de alface.

— Bom dia, bom dia. Ficou ótimo o sistema. Os meninos da horta viram e
ficaram animados.

— Que bom — disse Vera.

— Eles querem uma coisinha. Pra controlar os canteiros, quem planta o
quê, quem rega em que dia. — Ele pôs a sacola no balcão. — Quanto tempo leva
pra fazer um sisteminha desses?

Tainá abriu o caderno novo na primeira página.

— Quantos canteiros são?
:::

:::milestone
Fim do livro. A Casa Amarela tem uma API em produção: acervo com busca,
filtro e paginação; empréstimos com as onze regras da Vera num service que
ela consegue ler; autenticação e autorização por recurso; erros num formato
só; avisos pela fila, sem repetir; cache onde ele não mente; testes que
provam a regra em menos de um segundo e o contrato em menos de um minuto;
documentação gerada do código; e um deploy que é um script.

O Sistema de 2009 está numa pasta, com duas cópias, e ninguém apagou.
:::
