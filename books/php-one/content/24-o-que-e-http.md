...
O aplicativo de teste do acervo cadastrava empréstimo e recebia sempre a
mesma resposta: *"exemplar não informado"*.
...
O aplicativo da Tainá estava certo, e o `$_POST` também.
