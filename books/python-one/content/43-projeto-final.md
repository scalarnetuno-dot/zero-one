...
A frase do cliente tinha catorze palavras. A resposta honesta não é "feito,
uma linha": é uma pergunta de volta sobre o estoque, uma decisão registrada
por escrito, e uma tabela que lembra o que o status atual esqueceu. A Dona
Neuza entenderia as três. O slide do Sérgio, não.
:::
