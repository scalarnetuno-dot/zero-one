...
A página `/docs` apareceu sozinha no dia em que a primeira rota subiu.
Ninguém escreveu esse HTML. A tarefa agora é fazê-la bastar para a
Bem-Te-Vi integrar sem ligar para a Helena.
